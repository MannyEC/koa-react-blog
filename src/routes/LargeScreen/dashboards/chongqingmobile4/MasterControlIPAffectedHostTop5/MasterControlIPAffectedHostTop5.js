...
import classes from './MasterControlIPAffectedHostTop5.scss';
...
export default class MasterControlIPAffectedHostTop5 extends Component {
  static propTypes = {
    ...
    return (
        <div className={classes.container}>
          <div className={classes.header}>
            <span>{config && config.title ? config.title : 'TOP5主控IP影响主机情况'}</span>
          </div>
