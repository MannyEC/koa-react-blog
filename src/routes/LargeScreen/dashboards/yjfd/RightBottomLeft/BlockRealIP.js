...
import classes from './BlockRealIP.scss';

const client = new ApiClient();
const exampleData = [
    { ip: '1.1.121.1', blocktime: '2017-05-01 12:00',duration:'24h', unblocktime:'2017-05-02 11:00',operation:'停止'},
    { ip: '1.1.122.2', blocktime: '2017-05-01 12:00',duration:'24h', unblocktime:'2017-05-02 11:00',operation:'停止'},
    { ip: '1.1.123.3', blocktime: '2017-05-01 12:00',duration:'24h', unblocktime:'2017-05-02 11:00',operation:'停止'},
    { ip: '1.1.124.4', blocktime: '2017-05-01 12:00',duration:'24h', unblocktime:'2017-05-02 11:00',operation:'停止'},
    { ip: '1.1.125.5', blocktime: '2017-05-01 12:00',duration:'24h', unblocktime:'2017-05-02 11:00',operation:'停止'},
];
export default class BlockRealIP extends Component {
  static propTypes = {
    ...
    return (
      <YJFDLayout>
        <div className={classes.container}>
          ...
          {  <span>{config && config.title ? config.title : '实时封堵IP'}</span>}
          </div>}
          {data.length === 0 && (
          ...
          {data.length > 0 && <div className={classes.content}>
            <table className={classes.iptable}  border="0">
               ...
               <tbody>
                {data.map((item,idx) => (
                  <tr className={classes.tr} key={item.ip}>
                   <td>{item.ip}</td>
